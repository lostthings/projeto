...
<form action="listar2.php" method="POST">
 <label>Buscar Objeto:</label><input type="text" name="cidade" > 
...
$objeto = $_POST["objeto"];
	  ...
	  $stmt = $conexao->prepare("select  objeto,cidade,bairro,telefone,imagem,descricao from objetos where cidade=? or bairro=? or objeto=? ");
  ...
  <form name="formAluno" action="listar.php">
